...
export const LEVELS: LevelMeta[] = [
  ...
  },
  {
    ...
    description: "The Abyss's heart. Whatever escapes here doesn't come back the same.",
    accentColor: '#ff5722',
    shape: 'diamond',
  ...
  },
  {
    ...
    description: 'The quantum threshold where all recursive algorithms converge into the Abyss consciousness.',
    accentColor: '#fbbf24',
    shape: 'nestedSquares',
