...
export const puzzles: Puzzle[] = [
  // --- LEVEL 1: Laboratory ---
  {
    ...
    answer: [":", ": "],
    reward: "Gold Key",
    hint: "In Python, compound statements like function definitions, if-conditions, and loops require a delimiter before the indented block.",
    debrief: {
  ...
  },
  {
    ...
    reward: "Master Key",
    hint: "A while loop requires its termination condition to eventually evaluate to false, or an explicit break statement.",
    debrief: {
  ...
  },
  {
    ...
    reward: "Escape",
    hint: "This classic vulnerability occurs when untrusted user input is directly concatenated into a raw database query string.",
    debrief: {
      domain: "Web Security",
  ...
  // --- LEVEL 2: Server Room ---
  {
    ...
    reward: "Server Key",
    hint: "Without a second argument, useEffect executes after every single component render.",
    debrief: {
  ...
  },
  {
    ...
    answer: ["^", "^ "],
    reward: "Admin Card",
    hint: "The caret anchor asserts that the current position in the string is the start of the input.",
    debrief: {
  ...
  },
  {
    ...
    answer: ["MD5", "md5", "MD-5"],
    reward: "Escape",
    hint: "This 128-bit digest algorithm published by Ronald Rivest in 1992 suffers from catastrophic collision vulnerabilities.",
    debrief: {
  ...
  // --- LEVEL 3: Reactor Core ---
  {
    ...
    hint: "Returning a cleanup function removes listeners before component destruction.",
    debrief: {
  ...
  },
  {
    ...
    answer: ["PUT", "put"],
    reward: "Escape",
    hint: "This idempotent HTTP verb replaces the entire target resource state with the request payload.",
    debrief: {
  ...
  // --- LEVEL 4: Debug Wing ---
  {
    ...
    hint: "Every dynamic memory allocation in the C standard library heap must be paired with this release call.",
    debrief: {
  ...
  },
  {
    ...
    answer: ["8", "8 "],
    reward: "Cipher Chip",
    hint: "Left shift by N is equivalent to multiplying the binary number 1 by 2^N (2 to the power of 3).",
    debrief: {
  ...
  },
  {
    ...
    reward: "Escape",
    hint: "This bug occurs when program behavior depends on the uncontrollable timing or interleaving of concurrent execution threads.",
    debrief: {
  ...
  // --- LEVEL 5: The Nexus ---
  {
    ...
    hint: "This level-order graph exploration technique visits all neighboring nodes before moving to the next depth tier.",
    debrief: {
  ...
  },
  {
    ...
    reward: "Omni Core",
    hint: "This core Dynamic Programming strategy trades memory space to reduce exponential O(2^n) time to linear O(n).",
    debrief: {
  ...
  },
  {
    ...
    reward: "Escape",
    hint: "ZK-SNARKs and ZK-STARKs allow a prover to establish mathematical truth without disclosing the underlying witness data.",
    debrief: {
